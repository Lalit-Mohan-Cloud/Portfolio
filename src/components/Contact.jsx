      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-semibold italic">
            Ready to start a conversation? I'd love to hear about your project or discuss potential opportunities.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">iammohan1432@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">github.com/Lalit-Mohan-Cloud</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">www.linkedin.com/in/lalitmaurya1432</p>
                </div>
              </div>
            </div>
          </div>
